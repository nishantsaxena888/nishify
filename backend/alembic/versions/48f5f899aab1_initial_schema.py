...
Revision ID: 48f5f899aab1
Revises: 
Create Date: 2025-08-16 01:23:14.088535
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.PrimaryKeyConstraint('invoice_id', 'item_id', 'id')
    )
    ...
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.PrimaryKeyConstraint('po_id', 'item_id', 'id')
    )
