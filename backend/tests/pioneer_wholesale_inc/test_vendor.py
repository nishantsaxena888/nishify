...
def _inject_fk(payload):
    p = dict(payload)
    parent = _mk_parent('state', json.loads('{"id": 433, "name": "as"}'))
...
def test_create():
    global CREATED_ID
    payload = json.loads("{\"address\": \"finish\", \"contact_person\": \"individual\", \"email\": \"friend\", \"id\": 9852, \"name\": \"wonder\", \"phone\": \"pretty\", \"state_id\": 9427}")
