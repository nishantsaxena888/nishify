...
export const FormExample = () => {
  return (
    <div className={cn("px-5")}>
      ...
      <form>
        <Tabs defaultValue="account_information" orientation="vertical">
          <TabsList>
            <TabsTrigger value="account_information" accessKey="1">
              Account Information
            </TabsTrigger>
            <TabsTrigger value="pricing_and_tax" accessKey="2">
              Pricing & Tax
            </TabsTrigger>
            <TabsTrigger value="shipping_and_billing_address" accessKey="3">
              Shipping & Billing Address
            </TabsTrigger>
            <TabsTrigger value="sec_information" accessKey="4">
              Sec Information
            </TabsTrigger>
          </TabsList>

          <Card>
            <TabsContent value="account_information">
              <CardHeader>
                <CardTitle className="text-md">Account Information</CardTitle>
              </CardHeader>
              <CardContent className="flex  flex-col gap-4 text-balance">
                <div className="grid gap-6 py-10 border-t  ">
                  <div className="grid gap-6 md:grid-cols-3 grid-cols-1">
                    ...
                    <div className="flex flex-col gap-3">
                      <Label htmlFor="customer-fax">Product Promotion</Label>
                      <RadioGroup defaultValue="no" className="flex gap-2 pt-2">
                        <div className="flex items-center gap-3">
                          <RadioGroupItem value="yes" id="r1" />
                          <Label htmlFor="r1">Yes</Label>
                        </div>
            ...
            <TabsContent value="pricing_and_tax">
              <CardHeader>
                <CardTitle className="text-md">Pricing & Tax</CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col gap-4 text-balance">
                <div className="grid gap-6 py-10 border-t pt-4 ">
                  <div className="grid gap-6 md:grid-cols-3 grid-cols-1">
            ...
            <TabsContent value="shipping_and_billing_address">
              <CardHeader>
            ...
            <TabsContent value="sec_information">
              <CardHeader>
                <CardTitle className="text-md">Sec Information</CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col gap-4 text-balance">
                <div className="grid gap-6 pt-10 border-t  ">
                  <div className="grid gap-6 md:grid-cols-3 grid-cols-1">
